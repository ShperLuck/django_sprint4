...
urlpatterns = [
    ...
    path('profile/<str:username>/edit_profile/', views.ProfileUpdateView.as_view(), name='edit_profile'),
    path('profile/<str:username>/password_change/', views.password_change_view, name='password_change'),
